 ...
 */
K_THREAD_DEFINE(sem_consumer_tid,
		CONFIG_PACKAGE_SEM_DEMO_STACK_SIZE,
		sem_consumer_thread,
		NULL, NULL, NULL,
		CONFIG_PACKAGE_SEM_DEMO_CONSUMER_PRIORITY, 0, 0);

K_THREAD_DEFINE(sem_producer_tid,
		CONFIG_PACKAGE_SEM_DEMO_STACK_SIZE,
		sem_producer_thread,
		NULL, NULL, NULL,
		CONFIG_PACKAGE_SEM_DEMO_PRODUCER_PRIORITY, 0, 0);
